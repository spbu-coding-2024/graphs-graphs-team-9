...
class AlgoTest {
    ...
    @Test
    fun findKeyVertexTest() = runTest(testDispatcher) {
        val graph = GraphFactory.createUndirectedUnweightedGraph().apply {
            addVertex("A"); addVertex("B"); addVertex("C")
            addVertex("D"); addVertex("E")
            addEdge("A", "B"); addEdge("B", "C")
            addEdge("C", "D"); addEdge("D", "E")
            addEdge("E", "A"); addEdge("A", "D")
        }
    ...
    @Test
    fun fordBellmanNegativeWeightsTest() = runTest(testDispatcher) {
        val graph = GraphFactory.createDirectedWeightedGraph().apply {
            addVertex("A"); addVertex("B");
            addVertex("C"); addVertex("D")
    ...
    @Test
    fun fordBellmanNoPathTest() = runTest(testDispatcher) {
        val graph = GraphFactory.createDirectedWeightedGraph().apply {
            addVertex("A"); addVertex("B"); addVertex("C")
            addVertex("D")
