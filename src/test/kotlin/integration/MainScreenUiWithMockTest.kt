...
class MainScreenUiWithMockTest {
    ...
    fun setUp() {
        ...
        viewModel = MainScreenViewModel(
                graph = GraphFactory.createUndirectedUnweightedGraph(), // Initial empty graph
    ...
    fun sqliteSaveButton_becomesEnabled_afterSuccessfulSaveAs() = runTest(testDispatcher) {
        ...
        viewModel.setNewGraph(graphToSave) // Set the graph that will be saved
        ...
        coVerify {
            mockSqliteService.saveGraphToNewFile(
                    match { it === graphToSave }, // Ensure the correct graph instance was passed
